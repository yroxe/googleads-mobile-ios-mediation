...
- (nonnull instancetype)initWithMoPubNativeAd:(nonnull MPNativeAd *)mopubNativeAd
  ...
  if (self) {
    ...
    if (_mappedImage) {
      ...
      if (imageURL) {
        mappedImage = [[GADNativeAdImage alloc] initWithURL:imageURL scale:defaultImageScale];
      }
    }

    if (mappedIcon) {
      _mappedLogo = mappedIcon;
    } else {
...
- (nullable UIView *)mediaView {
  UIImageView *mainImageView = [[UIImageView alloc] initWithImage:_mappedImage.image];
